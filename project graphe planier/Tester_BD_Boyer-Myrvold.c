...
int main() {
    struct Graph metroGraph;
    // Initialisation du graphe avec le nombre de sommets
    initGraph(&metroGraph, 15);
    // Ajout d'arêtes pour simuler un réseau de métro
    addEdge(&metroGraph, 1, 2);
    addEdge(&metroGraph, 2, 3);
    addEdge(&metroGraph, 3, 4);
    addEdge(&metroGraph, 4, 5);
    addEdge(&metroGraph, 5, 6);
    addEdge(&metroGraph, 6, 7);
    addEdge(&metroGraph, 7, 8);
    addEdge(&metroGraph, 8, 9);
    addEdge(&metroGraph, 9, 10);
    addEdge(&metroGraph, 10, 11);
    addEdge(&metroGraph, 11, 12);
    addEdge(&metroGraph, 12, 13);
    addEdge(&metroGraph, 13, 14);
    addEdge(&metroGraph, 14, 1);
    addEdge(&metroGraph, 2, 5);
    addEdge(&metroGraph, 3, 6);
    addEdge(&metroGraph, 4, 7);
    addEdge(&metroGraph, 5, 8);
    addEdge(&metroGraph, 6, 9);
    addEdge(&metroGraph, 11, 15);
    addEdge(&metroGraph, 1, 6);
    addEdge(&metroGraph, 2, 7);
    addEdge(&metroGraph, 3, 8);
    addEdge(&metroGraph, 4, 9);
    addEdge(&metroGraph, 10, 14);
    addEdge(&metroGraph, 12, 15);
    addEdge(&metroGraph, 13, 14);
    addEdge(&metroGraph, 1, 7);
    addEdge(&metroGraph, 2, 8);
    addEdge(&metroGraph, 3, 9);
    addEdge(&metroGraph, 4, 5);
    addEdge(&metroGraph, 2, 3);
    addEdge(&metroGraph, 7, 8);
    addEdge(&metroGraph, 9, 10);
    ...
    addEdge(&metroGraph, 14, 1);
    addEdge(&metroGraph, 10, 11);
    addEdge(&metroGraph, 0, 15);
    addEdge(&metroGraph, 2, 12);

    if (isPlanar(&metroGraph)) {
